# Example script for validating metaobjects
# Move logic from main.py here if appropriate

import os
import json
from dotenv import load_dotenv
from shopify_metaobjects import ShopifyMetaobjectLoader, Metaobject
